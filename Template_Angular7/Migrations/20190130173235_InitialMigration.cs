    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TLoginBenutzer", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GanzerTag = table.Column<bool>(nullable: false),
                    ZeitUnbestimmt = table.Column<bool>(nullable: false),
                    ZeitBeginn = table.Column<DateTime>(nullable: false),
                    ZeitEnde = table.Column<DateTime>(nullable: false),
                    CreatedDate = table.Column<DateTime>(nullable: false),
                    LastModifiedDate = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.SerialColumn),
                    IdTermin = table.Column<int>(nullable: false),
                    ...
                    GanzerTag = table.Column<bool>(nullable: false),
                    DatumBeginn = table.Column<DateTime>(nullable: false),
                    DatumEnde = table.Column<DateTime>(nullable: false),
